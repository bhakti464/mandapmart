      ...
      {/*Left*/}
        <div className='w-full order-2 md:order-1 md:w-1/2 mt-10 md:mt-32 '>
          <div className="space-y-8">
            ...
            <p className="text-sm md:text-xl">At New Rajdhani Mandap Manufacturer, we create beautiful mandaps that blend tradition and elegance. Whether classic, modern, or theme-based, our designs make your special moments unforgettable!</p>
